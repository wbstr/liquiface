 ...
 * @author tveki
 */
@ApplyChange(DropNotNullConstraintChange.class)
public class DropNotNullConstraintChangeApplier implements ChangeApplier {

    @Override
    public void apply(Model model, Change c) {
        DropNotNullConstraintChange change = (DropNotNullConstraintChange) c;
