 ...
 * @author tveki
 */
@ApplyChange(AddNotNullConstraintChange.class)
public class AddNotNullConstraintChangeApplier implements ChangeApplier{

    @Override
    public void apply(Model model, Change c) {
        AddNotNullConstraintChange change = (AddNotNullConstraintChange) c;
