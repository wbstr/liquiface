...
public class LoadDatabaseWizardPanel1 extends AbstractWizardPanel {
    ...
    public void storeSettings(WizardDescriptor data) {
        data.putProperty(LoadDatabaseWizardConstants.SELECTED_DATABASE, component.getSelectedDatabase());        
    }
