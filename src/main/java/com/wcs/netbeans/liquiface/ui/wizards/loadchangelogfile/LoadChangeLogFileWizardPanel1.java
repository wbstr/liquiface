...
public class LoadChangeLogFileWizardPanel1 extends AbstractWizardPanel {
    ...
    public void storeSettings(WizardDescriptor wiz) {
        wiz.putProperty(LoadChangeLogFileWizardConstants.SELECTED_CHANGELOG_FILE, getComponent().getChangelogFile());
    }

    @Override
    public void validate() throws WizardValidationException {
        if (getComponent().getChangelogFile() == null){
            throw new WizardValidationException(null, "Select a changelog file!", null);
        }
    }
}
