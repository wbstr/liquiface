...
public class AppendToChangelogFileWizardPanel2 extends AbstractWizardPanel {
    ...
    public void storeSettings(WizardDescriptor wiz) {
        wiz.putProperty(AppendToChangelogFileWizardConstants.CHANGELOG_FILE, getComponent().getChangelogFile());
    }
